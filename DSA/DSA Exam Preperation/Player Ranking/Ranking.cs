                ...
                switch (commandParams[0])
                {
                    ...
                    case "find":
                        ...
                        if (typeToPlayerMap.ContainsKey(findType))
                        {
                            ...
                            string result = string.Format("Type {0}: " + "{1}", findType, string.Join("; ", players.Take(5)));
                            result.TrimEnd(';', ' ');
                    ...
                    case "ranklist":
                        ...
                        string rankingResult = string.Join("; ", rankedPlayers.Select(p => string.Format("{0}. {1}", playerPosition++, p.ToString())));
